                                    ...
                                    <table class="table table-borderless text-center table-nowrap align-middle mb-0" id="datatables">
                                        <thead>
                                            <tr class="table-active">
                                                ...
                                                <th scope="col" class="text-end">Total Volume (Ltr)</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">{{ number_format(ml_to_ltr1($item->tVolume), 2) }}</td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th class="text-end">{{number_format(ml_to_ltr1($products->sum('tVolume')), 2)}}</th>
...
@section('page-js')
    ...
    footerCallback: function (row, data, start, end, display) {
        ...
        // Update the footer
        $(api.column(5).footer()).html(totalTaxExc1.toFixed(2));
        $(api.column(6).footer()).html(totalTaxExc2.toFixed(2));
        $(api.column(7).footer()).html(totalTaxExc.toFixed(2));
    },
});
    </script>
@endsection
