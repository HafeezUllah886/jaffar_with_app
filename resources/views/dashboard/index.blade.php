                        ...
                        <div class="col">
                            <div class="mt-3 mt-md-0 py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0 cfs-22"><span class="counter-value"
                                                data-target="{{ totalPurchaseGst() }}">0</span></h2>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end col -->
                        <div class="col">
                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0 cfs-22"><span class="counter-value"
                                                data-target="{{ totalSaleGst() }}">0</span></h2>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end col -->
                        <div class="col">
                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0 cfs-22"><span class="counter-value"
                                                data-target="{{ myBalance() }}">0</span></h2>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end col -->
                            ...
                            <tbody>
                                @foreach ($topCustomersArray as $customer)
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="fs-14 my-1 fw-normal">{{ number_format($customer['balance']) }}
                                            </h5>
