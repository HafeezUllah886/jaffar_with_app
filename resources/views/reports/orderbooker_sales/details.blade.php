                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hstack gap-2 justify-content-end d-print-none p-2 mt-4">
                                ...
                                <a href="{{ route('reportOrderbookerSalesPrint', [$from, $to, $orderbooker->id]) }}" class="btn btn-success ml-4"><i class="ri-printer-line mr-4"></i> Print</a>
                            </div>
                            <div class="card-header border-bottom-dashed p-4">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0 mt-sm-0 mt-3">
                                        <h3>Orderbooker Sales Report</h3>
                                    </div>
                                </div>
                            </div>
                            <!--end card-header-->
                                    ...
                                    <table class="table table-borderless text-center table-nowrap align-middle mb-0" id="datatables">
                                        <thead>
                                            <tr class="table-active">
                                                ...
                                                <th scope="col" class="text-end">Volume Sold</th>
                                       ...
                                       <tr class="border-1 border-dark">
                                        ...
                                        <td class="text-start m-1 p-1 border-1 border-dark">{{$product->code}}</td>
                                        <td class="text-start m-1 p-1 border-1 border-dark">{{$product->name}}</td>
                                        <td class="text-end m-1 p-1 border-1 border-dark">{{$product->category}}</td>
                                        <td class="text-end m-1 p-1 border-1 border-dark">{{$product->vendor}}</td>
                                        <td class="text-end m-1 p-1 border-1 border-dark">{{ml_to_ltr($product->total_volume)}}</td>
                                        <td class="text-end m-1 p-1 border-1 border-dark">{{number_format($product->total_amount, 2)}}</td>
                                       </tr>
                                   @endforeach  
                                        </tbody>
                                       <tfoot>
                                        <tr class="border-1 border-dark">
                                            ...
                                            <td class="text-end">{{ml_to_ltr($products->sum('total_volume'))}}</td>
                                            <td class="text-end">{{number_format($products->sum('total_amount'), 2)}}</td>
                                           </tr>
                                        </tfoot>
                                    </table><!--end table-->
                                </div>
