        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                @if (auth()->user()->role == 'Admin')
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarReports">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('reportOrderbookerSales') }}" class="nav-link"
                                        data-key="t-basic-elements">Orderbooker Sales Report</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#freezer_setup" data-bs-toggle="collapse" role="button"
                            aria-expanded="false" aria-controls="sidebarApps">
                            <i class="ri-apps-2-line"></i> <span data-key="t-apps">Deep Freezers</span>
                        </a>
                        <div class="collapse menu-dropdown" id="freezer_setup">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{ route('deep_freezer.index') }}" class="nav-link"
                                        data-key="t-chat">Deep
                                        Freezers
                                        List </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('deep_freezer_movements.index') }}" class="nav-link"
                                        data-key="t-chat">
                                        Freezer Movements </a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ route('orderbooker_targets.index') }}">
                            <i class="ri-apps-2-line"></i> <span data-key="t-apps">Orderbooker Targets</span>
                        </a>
                    </li>
                    <li class="nav-item">
