                                            ...
                                            <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                                <thead>
                                                    <tr class="table-active">
                                                        ...
                                                        <th scope="col" class="text-end">Ltrs</th>
                                                ...
                                                <tbody id="products-list">
                                                   ...
                                                   $ltr = $product->product->volume * $product->qty;
                                                   $totalltr += $ltr;
                                                    @endphp
                                                       <tr>
                                                        ...
                                                        <td class="text-end p-1 m-1">{{ml_to_ltr($ltr)}}</td>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th></th>
                                                        <th class="text-end">{{ml_to_ltr($totalltr)}}</th>
