...
@section('page-js')
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(product) {
                    ...
                    if (found.length > 0) {
                        ...
                        html += '<td class="no-padding"><div class="input-group"><input type="number" class="form-control text-center" id="discount_percent_' + id + '" oninput="updateDiscount(' + id + ')" value="'+product.discount_percent+'"><input type="number" name="discount[]" oninput="updateChanges(' + id + ')" required step="any" value="'+product.discount+'" min="0" class="form-control text-center" id="discount_' + id + '"></div><input type="hidden" step="any" value="'+product.discount+'" id="packdiscount_' + id + '"></div></td>';
        ...
        function updateDiscount(id) {
            var discount_per = parseFloat($("#discount_percent_"+id).val());
            var price = parseFloat($("#price_"+id).val());
            var total =  (discount_per / 100) * price;
            $("#discount_"+id).val(total.toFixed(2));
            updateChanges(id);
        }
