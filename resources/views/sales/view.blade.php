                                            ...
                                            <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                                <thead>
                                                    <tr class="table-active">
                                                        ...
                                                        <th scope="col" class="text-end">RP Tax (Exc)</th>
                                                ...
                                                @foreach ($sale->details as $key => $product)
                                                        @php
                                                            ...
                                                            $disc_per = $product->discount / $product->price * 100;
                                                        @endphp
                                                    <tr class="border-1 border-dark">
                                                        ...
                                                        <td class="text-end m-1 p-1 border-1 border-dark">{{number_format($disc_per, 2)}}</td>
                                                        <td class="text-end m-1 p-1 border-1 border-dark">{{number_format($product->discount * $qty, 2)}}</td>
